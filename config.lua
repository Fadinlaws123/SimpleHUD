...
Config.Scripts = {
    postalSystem = true, -- Enable / Disable the server's postal system.
    AOPSystem = true, -- Enable / Disable the server's AOP system.
    DiscordHUDSystem = true, -- Enable / Disable the Discord link HUD
    FuelSystem = true, -- Enable / Disable the fuel HUD for your vehicle.
    SpeedometerSystem = true, -- Enable / Disable the speedometer that shows your vehicle speed.
    HideRadarOnFoot = true, -- Enable / Disable the Radar showing on foot. (Default = true)
    EconomySystem = false, -- Enable / Disable the economy hud.
}

Config.Messages = {
    AOPError = '~w~[~b~SimpleHUD~w~]: ~r~ERROR: ~y~You do not have permissions to use this command!', -- Message that appears to the user doing /aop if they lack permissions to use it!
    AOPSuccess = '~w~[~b~SimpleHUD~w~]: ~g~SUCCESS: ~y~You have changed the current AOP in the server!', -- Message that appears to the user doing /aop if they changed the AOP!
    PostalDelete = '~w~[~b~SimpleHUD~w~]: ~g~SUCCESS: ~y~You have removed the directions from your GPS!', -- Message that appears to the user doing /aop if they changed the AOP!
    PostalSet = '~w~[~b~SimpleHUD~w~]: ~g~SUCCESS: ~y~Directions has been marked on the GPS! Drive safe!' -- Message that appears to the user doing /aop if they changed the AOP!
}

Config.EconomyConfig = {
    Framework = "nd" -- Framework using for the economy. (Available: nd = NDCore | nat = NAT2K15 | standalone = no framework)
    -- More options coming soon. --
}

Config.AOPConfig = {
    DefaultAOP = "Sandy Shores", -- AOP that shows after each server restart.
    usePermissions = true, -- Enable / Disable using permissions for /aop
    acePerm = 'aop.staff' -- Ace permission group for permissions. (add_ace group.staff aop.staff allow)
}

Config.DiscordSystem = {
    DiscordLink = "https://discord.gg/CHANGEME" -- Link to your discord server.
}

Config.SpeedHUD = {
    speedMeasurement = 'mph', -- Choose what the speed calculator shows in, available options = mph | kmph
}
